  ...
  return (
    <DefaultLayout>
      <section className="container mx-auto px-4 py-8">
        ...
        {/* Nuova struttura per la compensazione CO₂ */}
        ...
        <article className="prose lg:prose-xl bg-white text-black p-4 text-center">
          ...
          <section className="mb-8">
            ...
            <div className="mb-4"></div>
            <div className="text-center">
              <ReactMarkdown>{tCo2('section3Content')}</ReactMarkdown>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="mb-4"></div>
            <div className="text-center">
              <ReactMarkdown>{tCo2('section4Content')}</ReactMarkdown>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="mb-4"></div>
            <div className="text-center">
              <ReactMarkdown>{tCo2('section5Content')}</ReactMarkdown>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="mb-4"></div>
            <div className="text-center">
              <ReactMarkdown>{tCo2('section6Content')}</ReactMarkdown>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="mb-4"></div>
            <div className="text-center">
              <ReactMarkdown>{tCo2('section7Content')}</ReactMarkdown>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="mb-4"></div>
            <div className="text-center">
              <ReactMarkdown>{tCo2('section8Content')}</ReactMarkdown>
            </div>
          </section>
